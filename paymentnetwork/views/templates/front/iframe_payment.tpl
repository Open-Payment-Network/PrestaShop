...
<iframe id="paymentgatewayframe" name="paymentgatewayframe" frameBorder="0" seamless="seamless" style="width:100%; height: 1600px;margin: 0 auto;display:block;"></iframe>
